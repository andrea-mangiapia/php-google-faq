...
$faq = [
    ...
    [
        ...
        'answer' => '<p>Il tuo account è associato a un paese (o territorio) nei Termini di servizio per poter stabilire due cose:</p>
                    <ol class="list-text" type="decimal">
                    ...
                    <p>Se il paese associato al tuo account non corrisponde al tuo paese di residenza, il motivo potrebbe essere la differenza tra il paese in cui lavori e il paese in cui risiedi, l\'installazione di una rete privata virtuale (VPN) per mascherare il tuo indirizzo IP oppure la residenza vicino a un confine territoriale. <a href="http://https://policies.google.com/faq">Contattaci</a> se ritieni che il paese associato al tuo account sia sbagliato.</p>'

    ],
    [
        'question' => 'Come faccio a rimuovere informazioni su di me dai risultati di ricerca di Google?',
        'answer' => '<p>I risultati di ricerca di Google rispecchiano i contenuti pubblicamente disponibili sul Web. I motori di ricerca non possono rimuovere i contenuti direttamente dai siti web,
                    quindi rimuovere risultati di ricerca da Google non consente di rimuovere i contenuti dal Web. Se desideri rimuovere qualcosa dal Web,
                    devi <a href="https://support.google.com/websearch/answer/9109?hl=it">contattare il webmaster</a> del sito su cui sono pubblicati i contenuti e chiedergli di apportare una modifica.
                    Inoltre, se, ai sensi delle leggi europee per la protezione dei dati, desideri richiedere la rimozione di determinate informazioni su di te visualizzate nei risultati di ricerca di Google, 
                    <a href="https://www.google.com/webmasters/tools/legal-removal-request?complaint_type=rtbf&visit_id=637943475425630143-290713224&hl=it&rd=1">fai clic qui</a>. 
                    ...
                    In caso di una richiesta di rimozione urgente, è inoltre possibile <a href="https://support.google.com/websearch/troubleshooter/3111061?hl=it">visitare la nostra pagina di assistenza per avere ulteriori informazioni</a>.</p>'
    ],
    [
        'question' => 'Quando faccio clic sui risultati della Ricerca Google, le mie chiavi di ricerca vengono inviate ai siti web?',
        'answer' => '<p>In alcuni casi sì. Quando fai clic su un risultato della Ricerca Google, il tuo browser web potrebbe reindirizzare alla pagina web di destinazione anche l\'indirizzo Internet, 
                    o URL, della pagina dei risultati di ricerca sotto forma di <a href="https://policies.google.com/privacy/key-terms#toc-terms-referrer-url">URL referrer</a>. 
...
<body>
    ...
    <main>
        <div class="container">
            <div class="faq">
                <?php foreach($faq as $faqText) { ?>
                    <h2>
                        <?php echo $faqText['question']; ?>
                    </h2>

                    <div>
                    <?php echo $faqText['answer']; ?>                        
                    </div>
                <?php } ?>
            </div>
        </div>
